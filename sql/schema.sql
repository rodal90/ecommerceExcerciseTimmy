create table Budget (currentAmount float(53), id integer generated by default as identity, idCurrentStatus varchar(255), primary key (id));
create table Comunication (amount float(53), id integer generated by default as identity, idBudget integer, idCustomerContact integer, messageDate date, idStatus varchar(255), message varchar(255), primary key (id));
...
create table STATUS (statusName varchar(255) not null, primary key (statusName));
